...
# 1 noeud 8 coeurs
#SBATCH -p public
#SBATCH --job-name=ScoreFlow_${first}
#SBATCH --nodes=1                    # Use one node
#SBATCH --sockets-per-node=2
#SBATCH --cores-per-socket=14
#SBATCH --ntasks=28                  # Run a single task        
#SBATCH -t 3:00:00
...
prev=ionized_solvated
for run in min_pr min_pr_bb min min_u heat_nvt heat_npt ; do
