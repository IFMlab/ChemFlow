...
for LIGAND in ${LIGAND_LIST[@]} ; do
    ...
    ;;
    "VINA")
echo "${WORKDIR}/${PROJECT}.chemflow/DockFlow/${PROTOCOL}/input/${LIGAND}.mol2"
    	    if [ ! -f  ${LIGAND}/ligand.pdbqt ] ; then
		python2 $(which prepare_ligand4.py) -l ${WORKDIR}/${PROJECT}.chemflow/DockFlow/${PROTOCOL}/input/${LIGAND}.mol2 -o ${LIGAND}/ligand.pdbqt -U 'lps'
        fi
    ;;
    "SMINA")
        if [ ! -f  ${LIGAND}/ligand.pdbqt ] ; then
