...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_dockingKeep_2.setGeometry(QtCore.QRect(170, 177, 111, 31))
        ...
        self.pushButton_docking_run = QtWidgets.QPushButton(self.tab_DockFlow)
        self.pushButton_docking_run.setGeometry(QtCore.QRect(120, 340, 86, 36))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_docking_run.setFont(font)
        self.pushButton_docking_run.setObjectName("pushButton_docking_run")
        self.pushButton_docking_archive = QtWidgets.QPushButton(self.tab_DockFlow)
        self.pushButton_docking_archive.setGeometry(QtCore.QRect(462, 340, 96, 36))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_docking_archive.setFont(font)
        self.pushButton_docking_archive.setObjectName("pushButton_docking_archive")
        self.pushButton_docking_postprocess = QtWidgets.QPushButton(self.tab_DockFlow)
        self.pushButton_docking_postprocess.setGeometry(QtCore.QRect(266, 340, 141, 36))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_docking_postprocess.setFont(font)
        self.pushButton_docking_postprocess.setObjectName("pushButton_docking_postprocess")
        ...
        self.label_postdock_logo = QtWidgets.QLabel(self.tab_DockFlow)
        self.label_postdock_logo.setGeometry(QtCore.QRect(229, 340, 36, 36))
        self.label_postdock_logo.setText("")
        self.label_postdock_logo.setPixmap(QtGui.QPixmap("../img/process.png"))
        self.label_postdock_logo.setScaledContents(True)
        self.label_postdock_logo.setObjectName("label_postdock_logo")
        self.label_archivedock_logo = QtWidgets.QLabel(self.tab_DockFlow)
        self.label_archivedock_logo.setGeometry(QtCore.QRect(424, 340, 36, 36))
        self.label_archivedock_logo.setText("")
        self.label_archivedock_logo.setPixmap(QtGui.QPixmap("../img/archive.png"))
        self.label_archivedock_logo.setScaledContents(True)
        self.label_archivedock_logo.setObjectName("label_archivedock_logo")
        self.label_dock_logo = QtWidgets.QLabel(self.tab_DockFlow)
        self.label_dock_logo.setGeometry(QtCore.QRect(82, 340, 36, 36))
        self.label_dock_logo.setText("")
        self.label_dock_logo.setPixmap(QtGui.QPixmap("../img/run.png"))
        self.label_dock_logo.setScaledContents(True)
        self.label_dock_logo.setObjectName("label_dock_logo")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_docking_run.setToolTip(_translate("MainWindow", "Run the docking experiment"))
        self.pushButton_docking_run.setText(_translate("MainWindow", "Dock"))
        self.pushButton_docking_archive.setToolTip(_translate("MainWindow", "<html><head/><body><p>Compress all files from the specified project, protocol, and receptor in a single tar.gz archive</p></body></html>"))
        self.pushButton_docking_archive.setText(_translate("MainWindow", "Archive"))
        self.pushButton_docking_postprocess.setToolTip(_translate("MainWindow", "<html><head/><body><p>Process and standardize the outputs for the specified project, protocol, and receptor</p></body></html>"))
        self.pushButton_docking_postprocess.setText(_translate("MainWindow", "Postprocess"))
